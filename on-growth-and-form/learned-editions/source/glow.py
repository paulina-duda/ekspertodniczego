...
MONO_FONT = Path(__file__).resolve().parent.parent.parent / "fonts" / "IBMPlexMono-Regular.ttf"
MONO_BOLD_FONT = Path(__file__).resolve().parent.parent.parent / "fonts" / "IBMPlexMono-Bold.ttf"
