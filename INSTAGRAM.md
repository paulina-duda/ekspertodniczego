...
account starts where the biology starts.

---

## Posted, in order

| # | Reel | Edition | Format | Hook | Credit |
| --- | --- | --- | --- | --- | --- |
| 1 | `folding_differential-growth_culture` | Wetware | field | — | — |
| 2 | `cleavage_embryonic-packing_substrate` | Substrate | field | *The only kind of growth that does not grow* | — |
| 3 | `growth-form_cosine-creature` | Biomorph | field | — | inspired by **yuruyurau**, credited on the post |
